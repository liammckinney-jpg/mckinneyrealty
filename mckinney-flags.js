/* =========================================================================
   ...
   LISTINGS_PUBLIC — gates every LINK SURFACE to the IDX routes: the
     ...
     false at launch (flip merge, Sept 15 2026) until Phase 1b ships a
     real PropTx snapshot.
   ...
   MOBILE_BAR — the phone-only persistent action bar on the homepage
     (call + Request a Consultation; fix spec 1.9, D-8). Off at launch
     (flip merge, Sept 15 2026); mckinney-nav.js reads it.
   ========================================================================= */
window.MCK_FLAGS = {
  LISTINGS_PUBLIC: false,
